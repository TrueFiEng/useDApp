...
var useCoingeckoPrice = function (base, quote) {
    ...
    var _a = (0, react_1.useState)(undefined), price = _a[0], setPrice = _a[1];
    var blockNo = (0, core_1.useBlockNumber)();
        ...
        function getPrice() {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, simple_price_1.getCoingeckoPrice)(base, quote)];
                        case 1:
                            tokenPrice = _a.sent();
                            setPrice(tokenPrice);
                            return [2 /*return*/];
    ...
    (0, react_1.useEffect)(function () {
        function getPrice() {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, simple_token_price_1.getCoingeckoTokenPrice)(contract, quote, platform)];
                        case 1:
                            tokenPrice = _a.sent();
                            setPrice(tokenPrice);
                            return [2 /*return*/];
