...
describe('getCoingeckoSimplePrice', function () {
    it('ethereum in usd price', function () {
        ...
        (0, chai_1.expect)((0, simple_price_1.getCoingeckoSimplePriceUri)('ethereum', 'usd')).to.eq(url);
    });
    it('bitcoin in usd price', function () {
        var url = 'https://api.coingecko.com/api/v3/simple/price?ids=bitcoin&vs_currencies=usd';
        (0, chai_1.expect)((0, simple_price_1.getCoingeckoSimplePriceUri)('bitcoin', 'usd')).to.eq(url);
    });
    it('dai in usd price', function () {
        var url = 'https://api.coingecko.com/api/v3/simple/price?ids=dai&vs_currencies=usd';
        (0, chai_1.expect)((0, simple_price_1.getCoingeckoSimplePriceUri)('dai', 'usd')).to.eq(url);
    });
});
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    getCoingeckoPrice = (0, simple_price_1.fetchCoingeckoPrice)(mockFetch);
                    _a = chai_1.expect;
