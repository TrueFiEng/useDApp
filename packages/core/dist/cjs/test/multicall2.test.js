        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, ethereum_waffle_1.deployContract)(deployer, src_1.ERC20Mock, args)];
                case 1:
                    tokenContract = _a.sent();
                    return [4 /*yield*/, (0, ethereum_waffle_1.deployContract)(deployer, src_1.MultiCall2)];
                case 2:
    ...
    it('Retrieves token balance using tryAggregate', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    blockNumber = _b.sent();
                    return [4 /*yield*/, (0, src_1.multicall2)(mockProvider, multicallContract.address, blockNumber, [call])];
                case 2:
                    result = _b.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, chai_1.expect)((0, src_1.multicall2)(mockProvider, multicallContract.address, blockNumber, [call])).to.be.eventually.rejected];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('Does not fail when doing multiple calls at once', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    blockNumber = _d.sent();
                    return [4 /*yield*/, (0, src_1.multicall2)(mockProvider, multicallContract.address, blockNumber, calls)];
                case 2:
                    result = _d.sent();
