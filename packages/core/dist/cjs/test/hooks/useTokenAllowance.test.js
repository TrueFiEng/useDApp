...
describe('useTokenAllowance', function () {
    ...
    it('returns 0 when spender is not yet approved', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, (0, testing_1.renderWeb3Hook)(function () { return (0, src_1.useTokenAllowance)(token.address, deployer.address, spender.address); }, {
    ...
    it('returns current allowance', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.sent();
                    return [4 /*yield*/, (0, testing_1.renderWeb3Hook)(function () { return (0, src_1.useTokenAllowance)(token.address, deployer.address, spender.address); }, {
                            mockProvider: mockProvider
                        })];
                case 2:
                    _a = _b.sent(), result = _a.result, waitForCurrent = _a.waitForCurrent;
