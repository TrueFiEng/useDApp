...
describe('useLocalStorage', function () {
    ...
    function render() {
        var key = 'foo';
        var result = (0, react_hooks_1.renderHook)(function () { return (0, useLocalStorage_1.useLocalStorage)(key); });
        return {
            getValue: function () { return result.result.current[0]; },
            setValue: function (value) { return (0, react_hooks_1.act)(function () { return result.result.current[1](value); }); },
