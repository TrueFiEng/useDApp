        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, ethereum_waffle_1.deployContract)(deployer, src_1.MultiCall)];
                case 2:
    ...
    it('Retrieves token balance using aggregate', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    blockNumber = _a.sent();
                    return [4 /*yield*/, (0, src_1.multicall)(mockProvider, multicallContract.address, blockNumber, [call])];
                case 2:
                    result = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, chai_1.expect)((0, src_1.multicall)(mockProvider, multicallContract.address, blockNumber, [call])).to.be.eventually.rejected];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, Promise.all([
                            (0, src_1.multicall)(mockProvider, multicallContract.address, blockNumber, [call]),
                            (0, src_1.multicall)(mockProvider, multicallContract.address, blockNumber, [call]),
                            (0, src_1.multicall)(mockProvider, multicallContract.address, blockNumber, [call]),
                            (0, src_1.multicall)(mockProvider, multicallContract.address, blockNumber, [call]),
                            (0, src_1.multicall)(mockProvider, multicallContract.address, blockNumber, [call]),
