...
describe('Currency', function () {
    ...
    it('NativeCurrency', function () {
        var ether = new src_1.NativeCurrency('Ether', 'ETH', src_1.Mainnet.chainId);
        var formatted = ether.format('123'.concat('0'.repeat(18)));
        chai_1.expect(formatted).to.equal('123 ETH');
    });
    it('Token', function () {
        var token = new src_1.Token('Fake Dai', 'FDI', src_1.Mainnet.chainId, constants_1.AddressZero);
