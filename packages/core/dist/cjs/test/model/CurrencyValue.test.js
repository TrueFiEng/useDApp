...
describe('CurrencyValue', function () {
    ...
    it('add', function () {
        ...
        (0, chai_1.expect)(function () { return a.add(e); }).to["throw"](TypeError);
        var c = a.add(b);
    ...
    it('sub', function () {
        ...
        var b = CurrencyValue_1.CurrencyValue.fromString(dollar, '69');
        var e = CurrencyValue_1.CurrencyValue.zero(euro);
        (0, chai_1.expect)(function () { return a.sub(e); }).to["throw"](TypeError);
        var c = a.sub(b);
    ...
    it('lt', function () {
        ...
        var c = CurrencyValue_1.CurrencyValue.fromString(dollar, '69');
        var e = CurrencyValue_1.CurrencyValue.zero(euro);
        (0, chai_1.expect)(function () { return a.lt(e); }).to["throw"](TypeError);
    ...
    it('lte', function () {
        ...
        var c = CurrencyValue_1.CurrencyValue.fromString(dollar, '69');
        var e = CurrencyValue_1.CurrencyValue.zero(euro);
        (0, chai_1.expect)(function () { return a.lte(e); }).to["throw"](TypeError);
    ...
    it('gt', function () {
        ...
        var c = CurrencyValue_1.CurrencyValue.fromString(dollar, '69');
        var e = CurrencyValue_1.CurrencyValue.zero(euro);
        (0, chai_1.expect)(function () { return a.gt(e); }).to["throw"](TypeError);
    ...
    it('gte', function () {
        ...
        var c = CurrencyValue_1.CurrencyValue.fromString(dollar, '69');
        var e = CurrencyValue_1.CurrencyValue.zero(euro);
        (0, chai_1.expect)(function () { return a.gte(e); }).to["throw"](TypeError);
