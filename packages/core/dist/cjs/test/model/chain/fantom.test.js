...
describe('Fantom Chain', function () {
    ...
    it('getExplorerAddressLink', function () {
        (0, chai_1.expect)(src_1.Fantom.getExplorerAddressLink(defaults_1.TEST_ADDRESS)).to.eq("https://ftmscan.com/address/".concat(defaults_1.TEST_ADDRESS));
    });
    it('getExplorerTransactionLink', function () {
        (0, chai_1.expect)(src_1.Fantom.getExplorerTransactionLink(defaults_1.TEST_TX)).to.eq("https://ftmscan.com/tx/".concat(defaults_1.TEST_TX));
    });
});
