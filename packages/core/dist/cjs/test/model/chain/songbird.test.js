...
describe('Songbird Chain', function () {
    ...
    it('getExplorerAddressLink', function () {
        (0, chai_1.expect)(src_1.Songbird.getExplorerAddressLink(defaults_1.TEST_ADDRESS)).to.eq("https://songbird-explorer.flare.network/address/".concat(defaults_1.TEST_ADDRESS));
    });
    it('getExplorerTransactionLink', function () {
        (0, chai_1.expect)(src_1.Songbird.getExplorerTransactionLink(defaults_1.TEST_TX)).to.eq("https://songbird-explorer.flare.network/tx/".concat(defaults_1.TEST_TX));
    });
});
