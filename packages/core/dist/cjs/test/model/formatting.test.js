...
describe('formatCurrency', function () {
    describe('input validation', function () {
        it('only allows decimal strings', function () {
            (0, chai_1.expect)(function () { return (0, formatting_1.formatCurrency)(formatting_1.DEFAULT_OPTIONS, 'some string'); }).to["throw"](TypeError);
            (0, chai_1.expect)(function () { return (0, formatting_1.formatCurrency)(formatting_1.DEFAULT_OPTIONS, 'deadbeef'); }).to["throw"](TypeError);
            (0, chai_1.expect)(function () { return (0, formatting_1.formatCurrency)(formatting_1.DEFAULT_OPTIONS, '1A2B'); }).to["throw"](TypeError);
        });
    });
    describe('separators', function () {
        ...
        var _loop_1 = function (decimals, input, expected) {
            it("formats ".concat(input, " as ").concat(expected, ", with ").concat(decimals, " decimals"), function () {
                var options = __assign(__assign({}, formatting_1.DEFAULT_OPTIONS), { decimals: decimals });
                var output = (0, formatting_1.formatCurrency)(options, input);
        ...
        it('can be customised', function () {
            var output = (0, formatting_1.formatCurrency)(__assign(__assign({}, formatting_1.DEFAULT_OPTIONS), { decimals: 5, thousandSeparator: ' ', decimalSeparator: ',' }), '1234567890987654321');
    ...
    describe('significantDigits', function () {
        ...
        var _loop_2 = function (significant, decimals, input, expected) {
            it("formats ".concat(input, " as ").concat(expected, ", with d=").concat(decimals, ", s=").concat(significant), function () {
    ...
    describe('fixedPrecisionDigits', function () {
        ...
        var _loop_3 = function (fixed, decimals, input, expected) {
            it("formats ".concat(input, " as ").concat(expected, ", with d=").concat(decimals, ", f=").concat(fixed), function () {
    ...
    describe('prefix and suffix', function () {
        it('applies prefix', function () {
            ...
            var output = (0, formatting_1.formatCurrency)(options, '123');
