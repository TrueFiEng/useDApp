...
export function useTokenPrice(baseCurrency: string, quateCurrency: string, overrides?: { factory: string }): BigNumber | undefined {
    ...
    const [reserve0, reserve1] = useContractCall(
