 ...
 * @public
 */
export const multicall2 = (fastEncoding: boolean) =>
  fastEncoding ? ethersEncodingMulticall2 : manualEncodingMulticall2

/**
 * @public
 */
export async function ethersEncodingMulticall2(
  provider: Provider,
  address: string,
  blockNumber: number,
  requests: RawCall[]
 ...
 * @public
 */
export async function manualEncodingMulticall2(
  provider: Provider,
  address: string,
  blockNumber: number,
  requests: RawCall[]
