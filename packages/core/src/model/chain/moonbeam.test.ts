...
describe('Moonbeam Chain', () => {
  ...
  it('getExplorerAddressLink', () => {
    expect(Moonbeam.getExplorerAddressLink(TEST_ADDRESS)).to.eq(
      `https://blockscout.moonbeam.network/address/${TEST_ADDRESS}/transactions`
    )
  })

  it('getExplorerTransactionLink', () => {
    expect(Moonbeam.getExplorerTransactionLink(TEST_TX)).to.eq(
      `https://blockscout.moonbeam.network/tx/${TEST_TX}/internal-transactions`
    )
  })
})
