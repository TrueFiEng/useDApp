...
Example is available [here](https://usedapp-example.netlify.app/), and full example code is available [here](https://github.com/TrueFiEng/useDApp/tree/master/packages/example).
