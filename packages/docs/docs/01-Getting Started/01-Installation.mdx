...
A more comprehensive example is available [here](https://usedapp-example.netlify.app/), with source code available [here](https://github.com/TrueFiEng/useDApp/tree/master/packages/example).
