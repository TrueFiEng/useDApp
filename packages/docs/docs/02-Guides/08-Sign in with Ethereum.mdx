...
Before adding SIWE module to your dapp, you need to configure [@fastify/siwe](https://github.com/TrueFiEng/fastify-siwe) on your backend.
...
`signIn` - callback that signs you out, so it destroys your current session.
