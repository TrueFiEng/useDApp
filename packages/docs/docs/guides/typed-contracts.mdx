...
`useDapp` provides support for [`typechain](https://www.npmjs.com/package/typechain) by default. When using typescript, you can generate types for the contracts you use and take advantage of type checking in your code. 
