...
**Example app using useSendTransaction**

App only sends 0.5 test ether from your account to our.
Firstly you need to connect with your MetaMask wallet and all ready.
