...
Example is available [here](https://example.usedapp.io/send).
...
:ref:`useContractFunction-label` accepts as first parameter both ethers [Contract](https://docs.ethers.io/v5/api/contract/contract/) and typechain generated contract [typechain](https://github.com/dethcrypto/TypeChain) (which extends ethers contract with function types).
