...
describe('useTokenBalance', function () {
    ...
    it('returns balance', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, src_1.renderWeb3Hook(function () { return core_1.useTokenBalance(token.address, deployer.address); }, {
                ...
                case 2:
                    ...
                    chai_1.expect(result.current).to.eq(deployMockToken_1.MOCK_TOKEN_INITIAL_BALANCE);
                    return [2 /*return*/];
            }
        });
    }); });
