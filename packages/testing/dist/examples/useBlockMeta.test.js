...
describe('useBlockMeta', function () {
    it('retrieves block timestamp and difficulty', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, src_1.renderWeb3Hook(core_1.useBlockMeta)];
                case 1:
                ...
                case 2:
                    ...
                    chai_1.expect(result.current.timestamp).to.be.a('date');
                    chai_1.expect(result.current.difficulty).to.not.be.undefined;
                    return [2 /*return*/];
            }
        });
    }); });
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, src_1.sleep(1000)];
                case 3:
                    _b.sent();
                ...
                case 5:
                    _b.sent();
                    chai_1.expect(result.current.timestamp).to.be.greaterThan(firstTimestamp);
                    return [2 /*return*/];
            }
        });
    }); });
