...
describe('useTokenAllowance', function () {
    ...
    it('returns 0 when spender is not yet approved', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, src_1.renderWeb3Hook(function () { return core_1.useTokenAllowance(token.address, deployer.address, spender.address); }, {
                ...
                case 2:
                    ...
                    chai_1.expect(result.current).to.eq(0);
                    return [2 /*return*/];
            }
        });
    }); });
    it('returns current allowance', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.sent();
                    return [4 /*yield*/, src_1.renderWeb3Hook(function () { return core_1.useTokenAllowance(token.address, deployer.address, spender.address); }, {
                            mockProvider: mockProvider
                        })];
                case 2:
                    _a = _b.sent(), result = _a.result, waitForCurrent = _a.waitForCurrent;
                ...
                case 3:
                    _b.sent();
                    chai_1.expect(result.error).to.be.undefined;
                    chai_1.expect(result.current).to.eq(ethers_1.utils.parseEther('1'));
                    return [2 /*return*/];
            }
        });
    }); });
